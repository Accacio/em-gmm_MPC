function [Phi,Responsibilities,pi_new,Sigma,loglikelihood,info] = cemgm_estimate(X,Y,phi_init,sigma_init,modes,emMaxIter,maxErr)
% EMGM_NESTIMATE - ESTIMATE N DIMENSIONAL
    ...
    for emInd=1:emMaxIter
        ...
        [Phi, pi_new, Sigma] = cem_update_parameters(X, Y, Phi, Responsibilities);
        Pi=pi_new;
